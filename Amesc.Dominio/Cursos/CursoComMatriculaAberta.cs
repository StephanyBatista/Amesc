...
{
    public class CursoComMatriculaAberta : Entidade
    {
        ...
        public CursoComMatriculaAberta() { }

        public CursoComMatriculaAberta(Curso curso, decimal preco, DateTime dataDeAbertura, DateTime dataDeFechamento, DateTime dataDoCurso)
        {
